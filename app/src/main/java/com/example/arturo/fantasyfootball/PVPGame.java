...
public class PVPGame extends AppCompatActivity implements View.OnClickListener{
    //team variables
    ...
    //textViews
    private TextView quarter, time, downDetails, playDetails;
                ...
                switch(view.getId()){
                    ...
                    case R.id.btnPassSave:
                        ...
                        if(offensePossesion == 1)
                            ...
                            validFG = fgAttempt(awayTeam, homeTeam);
                        if(validFG != -1)
                            updateGame();
                        break;
                    case R.id.btnRunQuit:
    ...
    private void initializeTVButtons(){
    ...
    private void pauseView(){
        ...
        playDetails.setText("qb " + homeTeam.getQBS() + "qb " + awayTeam.getQBS() + "\nk " + homeTeam.getKS());
    }
    ...
    private void endView(){
        homeTeamName.setText(homeTeam.getTeamName());
        homeTeamName.setText(awayTeam.getTeamName());
    ...
    private int matchup(int offense, int defense){
        ...
        int critO = (25 + ((offense - defense) * 7 / 6));
    ...
    private int fgAttempt(Team offense, Team defense){
        if(fieldPosition > 45){
            showPlayDetails = "Too Far to Attempt FG";
            return -1;
        }
